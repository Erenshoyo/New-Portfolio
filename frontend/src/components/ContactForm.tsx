...
export default function ContactForm({ email, phone, whatsapp }: ContactFormProps) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
      ...
      <div className="lg:col-span-2 space-y-4">
        ...
        {email && (
          ...
          >
            ...
            <div>
              <p className="text-xs font-semibold text-base-content/50 uppercase tracking-wider">Email Me</p>
              <p className="text-sm font-medium text-base-content group-hover:text-brand-primary transition-colors">{email}</p>
            </div>
          </a>
        )}
        ...
        {phone && (
          ...
          >
            ...
            <div>
              <p className="text-xs font-semibold text-base-content/50 uppercase tracking-wider">Call Me</p>
              <p className="text-sm font-medium text-base-content group-hover:text-brand-secondary transition-colors">{phone}</p>
            </div>
          </a>
        )}
        ...
        {whatsapp && (
          ...
          >
            ...
            <div>
              <p className="text-xs font-semibold text-base-content/50 uppercase tracking-wider">WhatsApp</p>
              <p className="text-sm font-medium text-base-content group-hover:text-green-550 transition-colors">{whatsapp}</p>
            </div>
          </a>
        )}
      </div>
      ...
      <div className="lg:col-span-3">
        <form onSubmit={handleSubmit} className="glass border-base-content/5 rounded-3xl p-6 md:p-8 space-y-5 shadow-lg relative">
          {success && (
            <div className="absolute inset-0 bg-base-100/90 backdrop-blur-sm rounded-3xl z-10 flex flex-col items-center justify-center text-center p-6 animate-fade-in">
              ...
              <h3 className="text-xl font-bold text-base-content mb-1">Message Sent Successfully!</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <label htmlFor="name" className="text-xs font-semibold text-base-content/60 uppercase">Your Name</label>
              <input
                id="name"
                type="text"
                required
            ...
            <div className="space-y-2">
              <label htmlFor="email" className="text-xs font-semibold text-base-content/60 uppercase">Your Email</label>
              <input
                id="email"
                type="email"
                required
          ...
          <div className="space-y-2">
            <label htmlFor="subject" className="text-xs font-semibold text-base-content/60 uppercase">Subject</label>
            <input
              id="subject"
              type="text"
              required
          ...
          <div className="space-y-2">
            <label htmlFor="message" className="text-xs font-semibold text-base-content/60 uppercase">Message</label>
            <textarea
              id="message"
              required
              rows={4}
